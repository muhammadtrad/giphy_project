...
var API_KEY = 'VMwZpERJCfaNYRO7075sM0f7EGdB8moj';
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  var root = "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=").concat(API_KEY, "&limit=2");
  return fetch(root).then(function (response) {
